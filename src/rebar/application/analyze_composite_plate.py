...
def analyze_composite_plate(
    ...
    if zone_search:
        report["zone_tradeoff"] = {
            ...
            "recombination": {"enabled": True, "method": "finite-cover-from-validated-proposals",
                              "baseline_point_limit": 16, "extra_point_limit": 2,
                              "maximum_pool_zones": 15000, "maximum_incidence_nnz": 1000000,
