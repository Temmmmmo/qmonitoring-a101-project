...
[`qmonitoring-rebar-review-mvp-0.1.5-code-only.zip`](downloads/qmonitoring-rebar-review-mvp-0.1.5-code-only.zip).
...
ещё не проверен; исходные FE/40d/stock fail остаются.
