...
def main(argv=None):
    ...
    for direction in PLATE_DIRECTIONS:
        ...
        parser.add_argument("--shk-" + key, type=Path, required=True)
    ...
    try:
        ...
        for direction in PLATE_DIRECTIONS:
            ...
            sources.append(PlateDirectionSource(getattr(args, "dxf_" + key), getattr(args, "shk_" + key)))
    ...
    for point in result["front"]:
        print(f'{point["additional_mass_kg"]:.3f} kg / {point["position_count"]} positions / '
