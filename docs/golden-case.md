...
6. Для каждой объединённой выдачи построить наш общеплитный фронт и найти ближайший к
   инженеру вариант; только после этого формировать метку `lambda`/положения колена.
